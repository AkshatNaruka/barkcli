...
### D3: Awesome Lists
- [~] **D3.1-D3.4**: Skipped — focused on PH, HN, and product-led distribution for now
...
### E3: Monetization (future)
- [ ] **E3.1**: Checkout flow for paid tiers (not launched yet)
- [ ] **E3.2**: Webhook-driven auto-provisioning

### E4: Landing v3
- [ ] **E4.1**: Pricing tiers (deferred — tool ships free and open source)
- [ ] **E4.2**: Sign-up flow → checkout → auto-create workspace
...
Not launched. The tool ships free and open source (MIT). Any future
monetization will be additive (e.g. hosted cloud sync) and never take away
from the local core.
