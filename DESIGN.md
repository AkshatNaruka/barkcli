...
|---|---|
| [Homebrew](https://brew.sh) | Install command as hero, amber/brown accents, code blocks everywhere, clean sections |
| [fish shell](https://fishshell.com) | Playful minimalism, white background, typography-driven, "works out of the box" tone |
| [Linear](https://linear.app) | Typography hierarchy, dark mode elegance, intentional spacing |
| Anthropic Frontend Design Skill | One orchestrated animation, deliberate typography, avoid AI-default patterns |
...
6. Pricing        — 3 cards, brown accent on Pro
